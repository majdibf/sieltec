...
public class SendMail {
      ...
      try {
            ...
            m_Session        =   Session.getDefaultInstance(m_properties,new Authenticator() {
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("sieltec3","pfesieltec"); // username and the password
                }
    ...
    public static void main(String[] args) {
      ...
      send_mail.sendMail("sieltec3@gmail.com", "nezih.ben.fredj@gmail.com", "Test Mail", "Hi this is Test mail from Java Srilankan Support");
    }
